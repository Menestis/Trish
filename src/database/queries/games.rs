...
pub async fn create_game(db: &TrishDatabase, game: &DbGame) -> Result<(), sqlx::Error> {
...
pub async fn delete_game(db: &TrishDatabase, guild: &GuildId, announcement_channel: &ChannelId, announcement_msg: &MessageId) -> Result<(), sqlx::Error> {
...
pub async fn get_game(db: &TrishDatabase, guild: &GuildId, announcement_channel: &ChannelId, announcement_msg: &MessageId) -> Result<Option<DbGame>, sqlx::Error> {
